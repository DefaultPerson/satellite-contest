Нужно разбить коллекции по группам. Группы делать на свое усмотрение. Не более 20 групп.

Например: "Новый год", "Техника", "роскошь".

Каждая коллекция должна участвовать хотя бы в одной группе.
Коллекции в группах могут встречаться более одного раза.



Вот список коллекций
```
{
